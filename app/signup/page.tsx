...
import {
    ...
    signupPhone,
    signupFayda,
    signupEmailInitialValues,
    signupFaydaInitialValues,
    signupPhoneInitialValues,
...
import {
    ...
    signupFaydaSchema,
    signupPhoneSchema,
} from "@/forms/schemas/signupFormSchema";
...
const LoginPage = () => {
    ...
    const handleSignupOptionChange = (value: string) => {
    ...
    const initialValueTypes = {
        email: signupEmailInitialValues,
        fayda: signupFaydaInitialValues,
        phone: signupPhoneInitialValues,
    };
    const formData = {
        email: signupEmail,
        fayda: signupFayda,
        ...
        sessionStatus !== "authenticated" && (
            <div className='min-h-screen font-barlow flex items-center justify-center px-5 relative overflow-clip bg-[#E1E7Ea]'>
                ...
                <div className='z-30 bg-white flex w-full max-w-[1400px] rounded-lg px-5 md:px-10'>
                    ...
                    <div className='w-full md:flex-1 border-r px-10 hidden md:flex items-center justify-center'>
                            ...
                            >
                                ...
                                <div className='flex justify-between items-center'>
                                    <div className='space-y-1 w-full'>
                                        ...
                                        <CustomSelectComponent
                                            ...
                                            placeholder="Select signup option"
                                        />
                                    </div>
                                </div>
                                <div className='space-y-8 max-w-[350px]'>
                                    <ConstructForm
                                        ...
                                        errors={errors}
                                        showTitle={false}
                                        formData={formData[selectedLoginOption] as any}
