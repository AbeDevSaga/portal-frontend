...
export const hcBirthFormConfig: FormConfig = {
    ...
    grouping: {
        ...
        groups: [
            {
                name: "Health Center Birth",
                label: "Health Center(HC) Birth Notification",
                order: 1,
            },
        ],
    },
    steps: [
        {
            ...
            fields: [
                ...
                {
                    group: "Twins Information",
                    groupOrder: 2,
                    type: "formArray",
                    key: "additionalInfo",
                    label: "Additional Information",
                    description:
                        "Add multiple information groups with additional details",
                    required: false,
                    gridCols: 12, // Full width for the formArray field

                    // Dynamic callbacks for the formArray field itself
                    ...
                    isHide: (dependentValues: any) => {
                        console.log(
                            "Dependent Values for additionalInfo hc birth:",
                            dependentValues
                        );
                        // Hide if no first name is provided
                        return dependentValues?.birthType !== "twin";
                    },
                    // isDisabled: (dependentValues: any) => {
                    //     // Disable if birth type is single
                    //     return dependentValues?.birthType === 'single';
                    // },
                    getDescription: (dependentValues: any) => {
                        if (dependentValues?.birthType === "twin") {
                            return "Additional information is required for twin births";
                        }
                        return "Add multiple information groups with additional details";
                    },

                    formArrayConfig: {
                        minItems: 0,
                        maxItems: 3,
                        addButtonText: "Add Information Group",
                        removeButtonText: "Remove Group",
                        groupTitle: "Add twin detail {index}",
                        defaultGroupCount: 1,
                        allowEmpty: true,
                        groupFields: [
                            {
                ...
                },
                {
                    ...
                    placeholder: "",
                    description: "Enter the child's father first name",
                    validators: [
                        {
                            type: "required",
                ...
                },
                {
                    ...
                    placeholder: "",
                    description: "Enter the child's father Father name",
                    validators: [
                        {
                            type: "required",
                            message: "Father's Father name is required",
                        },
                    ],
                    required: true,
                    gridCols: 6,
                },
                {
                    ...
                    placeholder: "",
                    description: "Enter the child's father Grandfather name",
                    validators: [
                        {
                            type: "required",
                            message: "Father's Grandfather name is required",
                        },
                    ],
                    required: true,
                    gridCols: 6,
                },
                {
                    ...
                    placeholder: "",
                    description: "Enter the child's mother first name",
                    validators: [
                        {
                            type: "required",
                ...
                },
                {
                    ...
                    placeholder: "",
                    description: "Enter the child's mother, father name",
                    validators: [
                        {
                            type: "required",
                            message: "Mother's father name is required",
                        },
                    ],
                    required: true,
                    gridCols: 6,
                },
                {
                    ...
                    placeholder: "",
                    description: "Enter the child's mother Grandfather name",
                    validators: [
                        {
                            type: "required",
                            message: "Mother's Grandfather name is required",
                        },
                    ],
                    required: true,
                    gridCols: 6,
