                ...
                <div className="mt-2 space-x-2 w-full flex items-center justify-between">
                  {subService.requests.map((request) => (
                    <a
                      key={request.type}
                      href={request.link}
                      className="w-full flex bg-slate-200 hover:bg-gray-600 hover:text-white items-center justify-center  text-xs p-2 bg-muted rounded hover:bg-muted/80 transition-colors"
                    >
                      {request.type}
                    </a>
                  ))}
